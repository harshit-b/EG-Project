        ...
        <ImageBackground source={require("../app/assets/bg.jpg")} style={styles.container}>
            ...
            <TouchableHighlight style={styles.dashboardCourses} onPress={() => navigation.navigate("Courses")}>
                ...
                <TouchableHighlight style={styles.dashboardGames} onPress={() => navigation.navigate("Games")}>
                    <Text style={styles.buttonInactive}> Games </Text>
                </TouchableHighlight>
                ...
                <TouchableHighlight style={styles.dashboardStats}  onPress={() => navigation.push("Stats")}>
                    <Text style={styles.buttonActive}> Stats </Text>
                </TouchableHighlight>
